    ...
    <body>
        ...
        <script>
            ...
            function sendMessage() {
                ...
                // Lấy đường dẫn context từ meta tag hoặc dữ liệu trong trang
                let contextPath = '';
                try {
                    const metaTag = document.querySelector('meta[name="contextPath"]');
                    if (metaTag) {
                        contextPath = metaTag.getAttribute('content') || '';
                        console.log('Context path from meta tag:', contextPath); // Kiểm tra đường dẫn context
                    } else {
                ...
                // Xây dựng URL và in ra console để kiểm tra
                const url = contextPath + '/chat'; // Đảm bảo đây là URL chính xác
                console.log('Sending request to:', url); // In ra URL để kiểm tra
